...
def main():
    p=argparse.ArgumentParser(); p.add_argument("--file",default="data/news.json"); p.add_argument("--id",required=True); p.add_argument("--source-image"); p.add_argument("--instagram-image"); a=p.parse_args()
